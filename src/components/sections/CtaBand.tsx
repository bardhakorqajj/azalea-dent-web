      ...
      <Container width="text" className="text-center">
        <Reveal>
          <AzaleaMark
            ...
            weight={2.6}
          />
          <h2 className="mt-9 text-[2.1rem] leading-[1.1] text-ink-900 sm:text-[2.8rem] dark:text-bone-50">
            {dict.appointment.title}
          </h2>
          <p className="mx-auto mt-5 max-w-xl text-[1.0625rem] leading-relaxed text-ink-600 dark:text-bone-300">
